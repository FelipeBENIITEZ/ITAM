...
public class ActivoController {
    ...
    public String nuevoActivoForm(Model model, Principal principal) {
        try {
            ...
            // ✅ CORREGIDO: Obtener TODOS los contratos (sin filtros de vigencia)
            model.addAttribute("contratos", contratoInfoRepository.findAllByOrderByCreatedAtDesc());
    ...
    public String guardarActivo(
        ...
        try {
            ...
            // PASO 4: Obtener contrato si se especificó (OPCIONAL)
            ContratoInfo contrato = null;
            if (contratoId != null) {
                contrato = contratoInfoRepository.findById(contratoId)
                    .orElseThrow(() -> new RuntimeException("Contrato no encontrado"));
                
                // ✅ CORREGIDO: Ya no validamos fechas de vigencia
                // El contrato ahora solo tiene número y descripción
            }
            ...
            activo.setDepartamento(presupuesto.getDepartamento());
            activo.setContrato(contrato); // Puede ser null
            ...
            // PASO 8: Guardar Garantía si se proporcionaron datos
            ...
            // ✅ CORREGIDO: Mensaje con número de contrato en lugar de nombre
            String mensaje = "Activo registrado exitosamente";
            if (contrato != null) {
                mensaje += " con contrato: " + contrato.getContratNumero();
            }
